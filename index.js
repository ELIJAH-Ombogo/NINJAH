...
async function downloadSessionData() {
    ...
    const sessdata = config.SESSION_ID.split("NINJAH-MD&")[1];
        ...
        Matrix.ev.on('connection.update', (update) => {
            ...
            if (connection === 'close') {
                ...
                if (initialConnection) {
                    console.log(chalk.green("NINJAH-Md Integration Successful️"));
                    Matrix.sendMessage(Matrix.user.id, { text: `NINJAH-Md Integration Successful️` });
